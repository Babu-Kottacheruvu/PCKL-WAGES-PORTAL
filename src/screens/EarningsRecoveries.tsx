...
import { type EarningsHead, type WorkerEarning, type AdvanceRecovery, type Welfare, type ElectricityCharge, type AdhocDeduction, initialEarningsHeads, initialWorkers, initialAdvances, initialWelfare, initialElectricity, initialDeductions } from '../data/earningsRecoveriesData';
...
export const EarningsRecoveries: React.FC = () => {
  ...
  const [workers] = useState<WorkerEarning[]>(initialWorkers);
  const [advances, setAdvances] = useState<AdvanceRecovery[]>(initialAdvances);
  const [welfare] = useState<Welfare[]>(initialWelfare);
  const [electricity] = useState<ElectricityCharge[]>(initialElectricity);
  ...
  const earningsHeadColumns: GridColDef[] = [
    { field: 'id', headerName: 'Earnings Head ID', width: 130 },
    { field: 'name', headerName: 'Name', flex: 1, minWidth: 180 },
    { field: 'epfApplicable', headerName: 'EPF', width: 90, renderCell: (params) => (params.value ? <Chip label="Yes" color="success" size="small" /> : <Chip label="No" size="small" />) },
    { field: 'esiApplicable', headerName: 'ESI', width: 90, renderCell: (params) => (params.value ? <Chip label="Yes" color="success" size="small" /> : <Chip label="No" size="small" />) },
    { field: 'bonusEligible', headerName: 'Bonus', width: 100, renderCell: (params) => (params.value ? <Chip label="Yes" color="success" size="small" /> : <Chip label="No" size="small" />) },
    { field: 'taxable', headerName: 'Taxable', width: 100, renderCell: (params) => (params.value ? <Chip label="Yes" color="success" size="small" /> : <Chip label="No" size="small" />) },
    { field: 'status', headerName: 'Status', width: 110, renderCell: (params) => <Chip label={params.value as string} color={params.value === 'Active' ? 'success' : 'warning'} size="small" /> },
    { field: 'lastUpdated', headerName: 'Last Updated', width: 120 },
    {
      field: 'actions', headerName: 'Actions', type: 'actions', width: 170, getActions: (params) => {
  ...
  const workerCols: GridColDef[] = [
    ...
    { field: 'basicWages', headerName: 'Basic Wages', width: 140, type: 'number', valueFormatter: (value: any) => currency(Number(value)) },
    { field: 'specialAllowance', headerName: 'Special Allowance', width: 160, type: 'number', valueFormatter: (value: any) => currency(Number(value)) },
    { field: 'overKiloWages', headerName: 'Over-Kilo Wages', width: 150, type: 'number', valueFormatter: (value: any) => currency(Number(value)) },
    { field: 'productionIncentive', headerName: 'Production Incentive', width: 170, type: 'number', valueFormatter: (value: any) => currency(Number(value)) },
    { field: 'holidayWages', headerName: 'Holiday Wages', width: 150, type: 'number', valueFormatter: (value: any) => currency(Number(value)) },
    { field: 'annualLeaveWages', headerName: 'Annual Leave Wages', width: 170, type: 'number', valueFormatter: (value: any) => currency(Number(value)) },
    { field: 'bonus', headerName: 'Bonus', width: 120, type: 'number', valueFormatter: (value: any) => currency(Number(value)) },
    { field: 'otherAllowances', headerName: 'Other Allowances', width: 150, type: 'number', valueFormatter: (value: any) => currency(Number(value)) },
    {
      field: 'grossEarnings', headerName: 'Gross Earnings', width: 160, type: 'number', valueGetter: (_value: any, row: any) => {
        const r = row as WorkerEarning; return r.basicWages + r.specialAllowance + r.overKiloWages + r.productionIncentive + r.holidayWages + r.annualLeaveWages + r.bonus + r.otherAllowances;
      }, valueFormatter: (value: any) => currency(Number(value))
    },
    {
      field: 'actions', headerName: 'Actions', type: 'actions', width: 160, getActions: (params) => [
  ...
  const advanceCols: GridColDef[] = [
    { field: 'id', headerName: 'Advance ID', width: 120 },
    { field: 'workerId', headerName: 'Worker ID', width: 120 },
    { field: 'workerName', headerName: 'Worker Name', width: 160 },
    { field: 'advanceAmount', headerName: 'Advance Amount', width: 150, valueFormatter: (value: any) => currency(Number(value)) },
    { field: 'recoveryStartDate', headerName: 'Start Date', width: 120 },
    { field: 'recoveryEndDate', headerName: 'End Date', width: 120 },
    { field: 'monthlyRecoveryAmount', headerName: 'Monthly Recovery', width: 160, valueFormatter: (value: any) => currency(Number(value)) },
    { field: 'outstandingBalance', headerName: 'Outstanding', width: 140, valueFormatter: (value: any) => currency(Number(value)) },
    { field: 'status', headerName: 'Status', width: 120, renderCell: (p) => <Chip label={p.value as string} size="small" color={p.value === 'Active' ? 'success' : p.value === 'Paused' ? 'warning' : 'default'} /> },
    {
      field: 'actions', headerName: 'Actions', type: 'actions', width: 200, getActions: (params) => [
  ...
  const welfareCols: GridColDef[] = [
    ...
    { field: 'monthlyDeduction', headerName: 'Monthly Deduction', width: 170, valueFormatter: (value: any) => currency(Number(value)) },
  ...
  const electricityCols: GridColDef[] = [
    ...
    { field: 'ratePerUnit', headerName: 'Rate/Unit', width: 110, valueFormatter: (value: any) => currency(Number(value)) },
    { field: 'chargeAmount', headerName: 'Charges', width: 120, valueFormatter: (value: any) => currency(Number(value)) },
    { field: 'status', headerName: 'Status', width: 120 },
  ];

  const deductionCols: GridColDef[] = [
    { field: 'id', headerName: 'Deduction ID', width: 130 },
    { field: 'workerId', headerName: 'Worker ID', width: 120 },
    { field: 'workerName', headerName: 'Worker Name', width: 160 },
    { field: 'deductionType', headerName: 'Type', width: 150 },
    { field: 'deductionAmount', headerName: 'Amount', width: 140, valueFormatter: (value: any) => currency(Number(value)) },
    ...
    {
      field: 'actions', headerName: 'Actions', type: 'actions', width: 180, getActions: (params) => [
  ...
  const summaryCols: GridColDef[] = [
    { field: 'workerId', headerName: 'Worker ID', width: 120 },
    { field: 'workerName', headerName: 'Worker Name', width: 200, flex: 1 },
    { field: 'grossEarnings', headerName: 'Gross Earnings', width: 170, valueFormatter: (value: any) => currency(Number(value)) },
    { field: 'totalDeductions', headerName: 'Total Deductions', width: 170, valueFormatter: (value: any) => currency(Number(value)) },
    { field: 'netWagePayable', headerName: 'Net Wage Payable', width: 170, valueFormatter: (value: any) => currency(Number(value)) },
        ...
        <div hidden={activeTab !== 0}>
          ...
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} sx={{ mb: 2 }}>
            ...
            <FormControl sx={{ minWidth: 160 }}>
              ...
              <Select label="Status" value={earningsFilterStatus} onChange={(e) => setEarningsFilterStatus(e.target.value as 'All' | 'Active' | 'Inactive')}>
        ...
        <DialogContent>
          <Stack spacing={2} sx={{ mt: 1 }}>
            ...
            <FormControl fullWidth>
              <InputLabel>Status</InputLabel>
              <Select label="Status" value={dialogValues.status || 'Active'} onChange={(e) => setDialogValues((p) => ({ ...p, status: e.target.value as 'Active' | 'Inactive' }))}>
                <MenuItem value="Active">Active</MenuItem>
                <MenuItem value="Inactive">Inactive</MenuItem>
              </Select>
            </FormControl>
